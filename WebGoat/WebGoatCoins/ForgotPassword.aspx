<%@ Page Title="" Language="VB" MasterPageFile="~/Resources/Master-Pages/Site.Master" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.vb" Inherits="OWASP.WebGoat.NET.WebGoatCoins.ForgotPassword" %>
...
<script>
    ...
    <asp:Panel ID="PanelForgotPasswordStep3" runat="server">
        ...
        <asp:Button ID="ButtonCustomerLogin" SkinID="Button" runat="server" Text="Go to Customer Login Page!" OnClick="ButtonGoToCustomerLogin_Click" />
    </asp:Panel>
